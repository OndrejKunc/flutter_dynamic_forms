...
class Label extends FormElement {
  ...
  Property<FontSize> get fontSizeProperty => properties[fontSizePropertyName] as Property<FontSize>;
  ...
  Property<int> get testIntProperty => properties[testIntPropertyName] as Property<int>;
  set testIntProperty(Property<int> value) =>
      registerProperty(testIntPropertyName, value);
  int get testInt => testIntProperty.value;

  Property<double> get testDoubleProperty => properties[testDoublePropertyName] as Property<double>;
  ...
  Property<bool> get testBoolProperty => properties[testBoolPropertyName] as Property<bool>;
